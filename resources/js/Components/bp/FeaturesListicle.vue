        ...
        <ul class="space-y-1">
          {[
            ...
            <li key={item} class="flex items-center gap-3">
              <svg
                ...
                viewBox="0 0 20 20"
                fill="currentColor"
                class="w-[18px] h-[18px] inline shrink-0 opacity-80"
              >
                <path
                  fill-rule="evenodd"
          ...
          <li class="flex items-center gap-3 text-accent font-medium">
            <svg
              ...
              viewBox="0 0 20 20"
              fill="currentColor"
              class="w-[18px] h-[18px] inline shrink-0"
            >
              <path
                fill-rule="evenodd"
                d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z"
...
const featuresEndRef = ref<HTMLElement | null>(null);
const featureSelected = ref<string>(features?.[0].name);

const selectedFeature = computed(() => features.find((f) => f.name === featureSelected.value))
</script>
    ...
    <div>
      <div class="grid grid-cols-4 md:flex justify-start gap-4 md:gap-12 max-md:px-8 max-w-3xl mx-auto mb-8">
        <span
          ...
          :key="feature.name"
          @click="featureSelected = feature.name"
        ...
        >
          <span
            :class="[
              'duration-100',
              {
                'text-primary': featureSelected === feature.name,
          ...
          <span
            :class="[
              ...
              {
                'text-primary': featureSelected === feature.name,
                'text-base-content/80 group-hover:text-base-content/60':
                  featureSelected !== feature.name,
              }
            ]"
          >
      ...
      <div class="bg-base-200">
        <div class="max-w-3xl mx-auto flex flex-col md:flex-row justify-center md:justify-start md:items-center gap-12">
          <div
            class="text-base-content/80 leading-relaxed space-y-4 px-12 md:px-0 py-12 max-w-xl animate-opacity"
            :key="featureSelected"
          >
            ...
            <component v-if="selectedFeature" :is="selectedFeature?.description" />
          </div>
        </div>
      </div>
    </div>
    <!-- Just used to know it's the end of the autoscroll feature (optional, see useEffect) -->
    <p class="opacity-0" ref="featuresEndRef"></p>
  </section>
</template>